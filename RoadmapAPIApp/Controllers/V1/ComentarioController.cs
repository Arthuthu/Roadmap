...
namespace RoadmapAPIApp.Controllers.V1
{
	...
	public class ComentarioController : ControllerBase
	{
		...
		[HttpPost]
		public async Task<ActionResult<List<ComentarioResponse>>> AddComentario([FromForm] ComentarioRequest comentario)
		{
			var requestComentario = _mapper.Map<ComentarioModel>(comentario);
			await _comentarioService.AddComentario(requestComentario);
